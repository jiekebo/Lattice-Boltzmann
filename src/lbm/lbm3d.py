...
plt.hold(True); plt.quiver(UY[:,:,0],UX[:,:,0], pivot='middle'); plt.imshow(BOUND[:,:,0]); plt.savefig('test00.png')
plt.hold(True); plt.quiver(UY[:,:,1],UX[:,:,1], pivot='middle'); plt.imshow(BOUND[:,:,1]); plt.savefig('test01.png')
plt.hold(True); plt.quiver(UY[:,:,2],UX[:,:,2], pivot='middle'); plt.imshow(BOUND[:,:,2]); plt.savefig('test02.png')
plt.hold(True); plt.quiver(UY[:,:,3],UX[:,:,3], pivot='middle'); plt.imshow(BOUND[:,:,3]); plt.savefig('test03.png')
plt.hold(True); plt.quiver(UY[:,:,4],UX[:,:,4], pivot='middle'); plt.imshow(BOUND[:,:,4]); plt.savefig('test04.png')
plt.hold(True); plt.quiver(UY[:,:,5],UX[:,:,5], pivot='middle'); plt.imshow(BOUND[:,:,5]); plt.savefig('test05.png')
plt.hold(True); plt.quiver(UY[:,:,6],UX[:,:,6], pivot='middle'); plt.imshow(BOUND[:,:,6]); plt.savefig('test06.png')
plt.hold(True); plt.quiver(UY[:,:,7],UX[:,:,7], pivot='middle'); plt.imshow(BOUND[:,:,7]); plt.savefig('test07.png')
plt.hold(True); plt.quiver(UY[:,:,8],UX[:,:,8], pivot='middle'); plt.imshow(BOUND[:,:,8]); plt.savefig('test08.png')
plt.hold(True); plt.quiver(UY[:,:,9],UX[:,:,9], pivot='middle'); plt.imshow(BOUND[:,:,9]); plt.savefig('test09.png')
